...
- (void)commonInit {
    ...
    dialogView.backgroundColor = [UIColor colorWithRed:0.0/255 green:64.0/255 blue:128.0/255 alpha:1.0];
...
- (void)show:(BOOL)animated {
    ...
    void(^animBlock)() = ^{
        [self setSubviewTransform:CGAffineTransformIdentity alpha:0.6f];
        self.backgroundColor = [UIColor clearColor];
    };
